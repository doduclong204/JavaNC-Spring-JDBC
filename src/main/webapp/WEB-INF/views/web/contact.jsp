            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <form:form modelAttribute="model" action="${webContactUrl}" method="GET" id="editForm">
                        <div class="row">
                            <div class="col">
                                <form:input type="text" class="form-control" name="fullName" placeholder="Họ và tên"
                                            path="fullName"/>
                            </div>
                            <div class="col">
                        ...
                        <form:input type="text" class="form-control mt-3" name="customerPhone"
                                    placeholder="Số điện thoại" path="phone"/>
                        <form:input type="text" class="form-control mt-3" name="note" placeholder="Nội dung"
                                    path="demand"/>
